...
/**
 * Debug block: right-click to open a simple GUI that builds and launches a {@link com.wf.wfballistics.MissileEntity}
 * from the block's position. A throwaway test harness — no crafting, no redstone, just a launch panel.
 */
